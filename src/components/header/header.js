        ...
        <>
            <section id='#'>
                ...
                <header className="text-center justify-center px-10 bg:">
                    <div className="text-center px-10 classname ">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3">
                            ...
                            <div className="overflow-hidden m-auto rounded-t-lg">
                                <img src={pic} className="h-100 w-100 rounded-es-3xl sm: mt-7 mb-2" alt="" />
                            </div>
                            <button className="rotate-90">
                                <a className="text-black font-bold text-dark scroll_down" href="#about">Scroll down</a>
                            </button>
                        </div>
                    </div>
                </header>
