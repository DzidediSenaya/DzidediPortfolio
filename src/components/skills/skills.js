    ...
    return (
        <section id='skills'>
            <div className="mt-4 mb-2">
                ...
                <div className="grid max-w-5xl mx-auto px-4 py-8">
                    {/* Front-end Development */}
                    <article className="bg-gray-900 rounded-lg border border-blue-500 transition duration-400 ease-in-out hover:border-blue-400 front-end">
                    ...
                    <article className="bg-gray-900 rounded-lg border border-blue-500 transition duration-400 ease-in-out hover:border-blue-400 back-end">
                    ...
                    {/* UI/UX Design */}
                    <article className="bg-gray-900 rounded-lg border border-blue-500 transition duration-400 ease-in-out hover:border-blue-400 ux">
                        <div className="bg-blue-900 py-4 rounded-t-lg">
                    ...
                    {/* Other Skills */}
                    <article className="bg-gray-900 rounded-lg border border-blue-500 transition duration-400 ease-in-out hover:border-blue-400 other">
                        <div className="bg-white py-4 rounded-t-lg">
